...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY LEGEND-MD 🤍*",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© CREATER 𝐸𝑅𝐹 legend boy *",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/4964gx.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> HEY IM ALIVE NOW  *LEGEND BOY*⚡",
// add alive msg here 
...
DEV: process.env.DEV || "92244180461",
